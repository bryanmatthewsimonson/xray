...
export function parseClaimEvent(event) {
    ...
    // NOTE (2026-07-20): the Phase 19 fact layer is RETIRED. Foreign
    // 30040s may still carry ['fact', …] tags — they are ignored here,
    // exactly as any reader that never knew the tag would ignore them.
    return {
