...
// same logic inline (it can't import — it's a standalone IIFE bundle
// that manifest.json loads as a `world: "MAIN"` content script).
// Keeping the canonical implementation here means the unit test pins one
