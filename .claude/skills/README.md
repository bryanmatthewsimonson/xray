...
| [`ux-designer`](ux-designer/SKILL.md) | Design-and-usability discipline: every surface must be usable by someone who did not build it. Reviews surfaces task-first, ranks findings by user harm, proposes layering over amputation, and runs the governance checklist (CONSTITUTION Arts. 3, 4.6, 5–8; TS H-5/H-7/S-4) on every review — a rendering that crosses a red line outranks every usability finding. Never merges, never writes code. |
...
| A surface is confusing, cluttered, or headed for laypeople | `ux-designer` (task-first review, findings ranked by user harm, governance checklist) |
