...
>
> **Harvest note (2026-07-03):** rescued from the abandoned
> `claude/decentralized-trust-systems-m393u` branch during the repo
> cleanup sweep; kept as the continuation-funding roadmap sketch per
> `EPISTACK_WIN_PLAN.md` §2. Its code was stale (would revert Phases
> 8–15) and was not harvested. **The event kinds proposed below
> (30050–30056) collide with live X-Ray kinds and MUST be renumbered
> off the 30050–30065 block before any part of this is built.** Some
> substrate descriptions (e.g. kind-30043 evidence links) predate
> Phase 11 and are stale.
