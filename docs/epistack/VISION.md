...
-   shared, or at least mutually-intelligible protocols[3] and data formats, especially for largely-objective *structural* and *provenance* levels of investigation
...
1. Collective sensemaking: situations where not everyone has the same information or incentives.
2. These information-hygiene moves happen throughout forms and types of communication.
3. Protocols, when built for today's and future AI systems, can look [much different than what may be typically envisioned](https://newsletter.squishy.computer/p/agents-want-flexible-schemas). For example, it's possible that extensive use of natural language is best, rather than a restrictive schema with limited concepts and simplified information.
